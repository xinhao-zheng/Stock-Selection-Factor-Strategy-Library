...
- **Industry control** — a list weight on the core factor (e.g. `[3,2,1]`) imposes a per-industry quota; `neutralized` on the industry entry ranks within industry, not across the market.
